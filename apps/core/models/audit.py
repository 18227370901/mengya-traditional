...
class AuditLog(models.Model):
    ...
    ACTION_CHOICES = [
        ...
        ("forgot_password_attempt", "尝试找回密码"),
        ("forgot_password_reset", "密保找回密码"),
        ("forgot_password_locked", "找回密码锁定"),
        # 用户管控
        ("user_update", "编辑用户"),
        ...
        ("permission_update", "修改用户权限"),
        ("security_config", "安全风控设置"),
        ("reg_mode", "注册模式切换"),
        ("invite_create", "创建邀请链接"),
        ...
        # 健康与生长
        ("health_record_create", "添加健康记录"),
        ("health_record_delete", "删除健康记录"),
        # 清单
        ("shopping_list_create", "创建待产清单"),
        ("shopping_list_generate", "智能生成清单"),
        ("shopping_item_update", "更新清单商品"),
        ("shopping_item_delete", "删除清单商品"),
        # AI 模块
        ("ai_chat", "AI助手问答"),
        ("ai_compare", "AI商品对比"),
        ("ai_evaluate", "AI商品一键评测"),
        ("ai_config", "AI配置变更"),
        ("ai_config_test", "AI连接测试"),
        # 系统运维
        ("audit_delete", "删除审计日志"),
        ("audit_retention", "设置日志保留天数"),
    ]
    ...
    username = models.CharField(max_length=150, blank=True, default="", verbose_name="操作人账号快照")
